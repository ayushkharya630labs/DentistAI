...
export default function Result() {
    ...
    return (
        <div className="h-screen overflow-hidden flex flex-col max-w-3xl mx-auto">
            ...
            <div className="flex-1 overflow-y-auto space-y-4 bg-glass rounded-xl p-4">
                ...
                {messages.map((m, i) => (
                    ...
                    >
                        ...
                        <div
                            className={`max-w-[75%] px-4 py-3 rounded-2xl text-sm leading-relaxed ${m.role === "user"
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        {parsed.observations && (
                                            <div className="bg-black/40 p-4 rounded-xl border border-purple-500/30">
                                                ...
                                                <ReactMarkdown>{parsed.observations}</ReactMarkdown>
                                            </div>
                                        )}

                                        {parsed.question && (
                                            <div className="bg-purple-600/20 p-4 rounded-xl border border-purple-500">
                                        ...
                                        {parsed.disclaimer && (
                                            <div className="text-xs text-gray-400 pt-2">
                                                <ReactMarkdown>{parsed.disclaimer}</ReactMarkdown>
                                            </div>
                                        )}
